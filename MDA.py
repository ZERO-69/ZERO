# This Tool Creat By GOD
# Enjoy The Best UA Create Tool 
...
\x1b[1;97m-------------------------------------------
\x1b[1;92m>>\x1b[1;97m Author  :  ANISH GOD
\x1b[1;92m>>\x1b[1;97m Github  :  github.com/anish-XD-0
\x1b[1;92m>>\x1b[1;97m Tools   :  User-Agent Generator
\x1b[1;97m-------------------------------------------
    """)
    
    num_user_agents = int(input("\033[1;37m How Many User Agents Do You Want To Create ? "))
    user_agents = generate_user_agents(num_user_agents)
    print("\033[0;32m Generating User Agents Loading...")
    time.sleep(8)
    

    print("\033[0;37m Generated User Agents : \033[0;32m")
    for idx, user_agent in enumerate(user_agents, start=1):
        print(f"\033[0;37mUser Agent { idx} : \033[0;32m{user_agent}")
