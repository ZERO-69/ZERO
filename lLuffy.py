...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FBAN/FB4A;FBAV/'+fbap+';FBBV/'+fbbv+';FBDM/{density=1.5,width=540,height=960};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/'+android_version+';FBSV/6;FBCA/armeabi-v7a:armeabi:;]"
